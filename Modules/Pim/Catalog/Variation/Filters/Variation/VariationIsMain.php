 ...
 */
abstract class VariationIsMain implements \Plenty\Modules\Catalog\Contracts\Filters\CatalogFilterBuilderContract

{

	const KEY = 'variationIsMain';
...
template definition this should not be called. Use the specific setter methods instead.
	...
	abstract public function setShouldBeMain(
		bool $shouldBeMain
	):self;
